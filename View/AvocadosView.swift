        ...
        VStack {
            ...
            Image("avocado")
                ...
                .shadow(color: Color("ColorBlackTransparentDark"),
                        radius: 12, x:10, y:8 )
                .scaleEffect(self.pulsateAnimation ? 1 : 0.85)
            ...
            VStack {
                Text("Avocados".uppercased())
                    ...
                    .padding()
                    .shadow(color: Color("ColorBlackTransparentDark"), radius: 4, x: 0, y: 4.0)
                Text("""
...
""")
                    ...
                    .lineSpacing(8)
                    .frame(minWidth: 300, maxWidth: .infinity,  maxHeight: 150, alignment: .center)
            }
            .padding()
